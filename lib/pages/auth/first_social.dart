...
class FirstSocialPage extends StatefulWidget {
  const FirstSocialPage({Key? key}) : super(key: key);

  @override
  _FirstSocialPageState createState() => _FirstSocialPageState();
}

class _FirstSocialPageState extends State<FirstSocialPage> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: _changePicture,
            child: const Text('Profile Picture (optional)',
                style: TextStyle(
