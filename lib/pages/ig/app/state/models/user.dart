...
class StreamagramUser {
  ...
  factory StreamagramUser.fromMap(Map<String, dynamic> map) {
    return StreamagramUser(
      ...
      userAbout: map['user_about'] as String,
  ...
  @override
  String toString() {
    return '''UserData(firstName: $firstName, lastName: $lastName, fullName: $fullName, user_about: $userAbout, profilePhoto: $profilePhoto, profilePhotoResized: $profilePhotoResized, profilePhotoThumbnail: $profilePhotoThumbnail)''';
  }
