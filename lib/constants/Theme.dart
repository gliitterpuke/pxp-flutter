...
class pxpColors {
  ...
  static const Color bgColorScreen = Color(0xFF000000);

  static const Color menu = Color(0xFF161618);

  static const Color card = Color(0xFF212124);

  static const Color secondaryT = Color(0xFF818181);
